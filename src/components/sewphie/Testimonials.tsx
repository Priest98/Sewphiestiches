...
export const Testimonials = () => {
  return (
    <section className="relative z-20 -mt-[20px] sm:-mt-[40px] md:-mt-[80px] rounded-t-[20px] sm:rounded-t-[40px] md:rounded-t-[80px] py-16 sm:py-24 md:py-32 lg:py-40 bg-cream-deep overflow-hidden shadow-soft">
        ...
        <div className="container relative z-10">
          ...
          <div className="mt-12 sm:mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            {quotes.map((t, i) => (
              <motion.figure 
                key={t.name} 
                ...
                className="flex flex-col bg-cream p-6 sm:p-8 md:p-10 rounded-[1.5rem] sm:rounded-[2rem] hover:shadow-luxury transition-all duration-500 border border-gold/5"
              >
                <span className="font-display text-4xl sm:text-5xl md:text-6xl text-gold leading-none mb-3 sm:mb-4">"</span>
                <blockquote className="font-display text-base sm:text-lg md:text-xl text-bottle leading-snug italic flex-1">
                  {t.q}
                </blockquote>
                <div className="gold-divider mt-6 sm:mt-8 mb-4 sm:mb-5 max-w-[60px]" />
                <figcaption>
                  <p className="text-xs sm:text-sm font-medium text-bottle">{t.name}</p>
                  <p className="text-[0.6rem] sm:text-[0.65rem] uppercase tracking-luxury text-muted-foreground mt-1">
                    {t.role}
                  </p>
                </figcaption>
              </motion.figure>
