...
const items = [
  ...
  { img: "/collections/Corporate Suit/IMG_0804.JPG (1).jpeg", title: "Corporate Suit", caption: "Power, structure, and authority.", tall: false },
  ...
  { img: "/collections/Wedding look/IMG_7700.JPG.jpeg", title: "Wedding Look", caption: "The perfect style for your big day.", tall: false },
];
      ...
      <div className="container">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {items.map((item, i) => (
            <motion.a
              key={item.title}
              href={`/collection?category=${encodeURIComponent(item.title)}`}
              data-cursor="View"
